...
const PhoboPatientRegistration = ({
  items = [],
  columns = [],
  itemsPerPage = 5,
      ...
      ...transformedColumns,
      {
        ...
        cell: ({ row }) => (
          <div className="flex space-x-2">
            <button
              className="text-sm text-white bg-blue-600 hover:bg-teal-700 px-2 py-1 rounded"
              onClick={() => onUpdate && onUpdate(row.original)}
            >
              Edit
            </button>
            <button
              className="text-sm text-white bg-red-600 hover:bg-teal-700 px-2 py-1 rounded"
...
export default PhoboPatientRegistration;
