...
const Sidebar = ({
  ...
  const user = {
    name:storedUserName,
    shortName: "DrReddy",
    department: "Reception Panel ",
    shortDept: "Reception Panel",
  ...
  const allMenuItems = [
    { type: "label", label: "Reception Panel" },
    { name: "Dashboard", icon: <FaHome />, link: "", roles: ["reception"] },

    {
      name: "Patient Registration",
      icon: <FaUserDoctor />,
      roles: ["reception"],
      link: "/add-patient-registration-recp",
    },
 
    {
      ...
      roles: ["reception"],
      children: [
        { name: "Registration Details", link: "/patient-registration-recp", roles: ["reception"] },
      ]
    },
