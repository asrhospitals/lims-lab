...
const Sidebar = ({
  ...
  const allMenuItems = [
    ...
    },
    {
      ...
      roles: ["phlebotomist"],
      children: [
        { name: "Report Entry", link: "/", roles: ["phlebotomist"] },
        { name: "Print Report", link: "/print-report", roles: ["phlebotomist"] },
        { name: "Doctor Monitoring", link: "/doctor-monitoring", roles: ["phlebotomist"] },
        { name: "Pending Report Register", link: "/pending-report-register", roles: ["phlebotomist"] },
        { name: "Daily Patient Register", link: "/daily-patient-register", roles: ["phlebotomist"] },
        { name: "Critical Report Register", link: "/critical-report-register", roles: ["phlebotomist"] },
        { name: "Report Register", link: "/report-register", roles: ["phlebotomist"] },
        { name: "Patient Register", link: "/patient-register", roles: ["phlebotomist"] },
        { name: "Date Wise Test Count", link: "/date-wise-test-count", roles: ["phlebotomist"] },
        { name: "Tube Count Report", link: "/tube-count-report", roles: ["phlebotomist"] },
        { name: "Test Count for Doctor", link: "/test-count-for-doctor", roles: ["phlebotomist"] },
        { name: "Monthly Test Register", link: "/monthly-test-register", roles: ["phlebotomist"] },
        { name: "Nodal Wise Test Count", link: "/nodal-wise-test-count", roles: ["phlebotomist"] },
        { name: "Hospital Wise Patient Register", link: "/hospital-wise-patient-register", roles: ["phlebotomist"] },
        { name: "Hospital Wise Test Count", link: "/hospital-wise-test-count", roles: ["phlebotomist"] },
      ]
    },
