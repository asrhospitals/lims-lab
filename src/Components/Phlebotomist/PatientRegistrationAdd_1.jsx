  ...
  const {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            ...
            page: data.page, // You may want to generate or retrieve this dynamically
            pregdate: data.dob, // Assuming dob is in the correct format
            mobile: data.mobileNumber,
            registration_status: "Center",
            pgender: data.gender,
            hospital_name: hospitalName,
            tests: [
                {
                patient_test_id: '', // You may want to generate or retrieve this dynamically
                investigation_id: '', // This should be based on your application logic
                testname: "Total Protein", // Example test name
                department: "Biochemistry", // Example department
                status: "node", // Example status
            ...
            bills: [
                ...
                ptotal: data.ptotal, // Example total
                pamt: 13, // Example amount
                pamtmode: null,
                pamtmthd: null,
                },
            ],
            ppdata: [
                ...
                pscheme: data.patientSourceType,
                refdoc: data.referralDoctorName,
                remark: data.remark, 
                attatchfile: data.attachedFile ? data.attachedFile[0].name : "", 
                },
            ],
            abha_data: [
                {
              
                isaadhar: data.creationMode === "aadhaar",
                ismobile: data.creationMode === "mobile",
                aadhar: data.creationMode === "aadhaar" ? data.idNumber : "",
                mobile: data.mobileNumber,
                abha: "", 
                },
            ],
            ...
            const response = await axios.post("https://asrphleb.asrhospitalindia.in/phelb/add-patient-test", payload, {
            headers: {
            ...
            navigate("/patient-registration"); // Redirect to the patient list
        } catch (error) {
            // Notify error
      ...
      <div className="fixed top-[61px] w-full z-10">
        <nav className="flex items-center text-sm font-medium justify-start px-4 py-2 bg-gray-50 border-b shadow-lg">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <Link to="/patient-registration" className="text-gray-700 hover:text-teal-600">Patients</Link>
            </li>
            <li className="text-gray-400">/</li>
            <li className="text-gray-500">Add Patient (Patient Registration) </li>
          </ol>
        </nav>
      </div>
      ...
      <div className="w-full mt-16 px-4 space-y-4 text-sm">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200">
          <div className="border-b border-gray-200 px-6 py-4 bg-gradient-to-r from-teal-600 to-teal-500">
            <h4 className="font-semibold text-white">Add Patient (Patient Registration)</h4>
          </div>
