...
const AddSpecimenType = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      await axios.post(
        "https://asrlabs.asrhospitalindia.in/lims/master/add-specimen",
        {
      ...
      toast.error(
        error.response?.data?.message || "❌ Failed to add specimen type."
      );
    } finally {
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  {...register("specimenname", {
                    ...
                    onInput: () => trigger("specimenname"),
                    onKeyUp: () => trigger("specimenname"),
                  })}
              ...
              <div className="space-y-1">
                ...
                <input
                  ...
                  {...register("specimendes", {
                    ...
                    onInput: () => trigger("specimendes"),
                    onKeyUp: () => trigger("specimendes"),
                  })}
