...
const AddInvestigation = () => {
    ...
    const fetchData = async () => {
      try {
        const [deptRes, subDeptRes, roleRes, hospRes, specRes, nodalRes, instrRes] = await Promise.all([
          ...
          axios.get("https://asrlabs.asrhospitalindia.in/lims/master/get-nodalcenter", { headers: { Authorization: `Bearer ${authToken}` } }),
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const authToken = localStorage.getItem("authToken");
      await axios.post(
        "https://asrlabs.asrhospitalindia.in/lims/master/add-technician",
        payload,
