...
const AddReflexTests = ({ showModal, handleClose, onDataUpdate }) => {
    ...
    const handleAddTest = (e) => {
        ...
        if (!formData.triggerParameter) {
            alert("Trigger Parameter is required");
            return;
        }
        
        if (!formData.reflexTest) {
            alert("Reflex Test is required");
            return;
        }
        
        setSelectedTests([...selectedTests, formData.reflexTest]);
        setFormData({ ...formData, reflexTest: '' });
    };
