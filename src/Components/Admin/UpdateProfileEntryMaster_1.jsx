  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const payload = {
        profileName: data.profileName,
        profilecode: data.profilecode,
        alternativebarcode: data.alternativebarcode === true || data.alternativebarcode === "true",
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <div className="flex space-x-4 pt-2">
                  {[true, false].map((val) => (
                    <label key={String(val)} className="inline-flex items-center">
                      <input
                        type="radio"
                      ...
                      />
                      <span className="ml-2">{val ? "Yes" : "No"}</span>
                    </label>
                  ))}
                </div>
