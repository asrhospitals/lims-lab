...
const AddInvestigationResultMandatoryConditions = ({ showModal, handleClose }) => {
                ...
                <form onSubmit={handleAdd} className="mt-4">
                    <div className="mb-4">
                        ...
                        >
                            ...
                            <option value="Result A">Result A</option>
                            <option value="Result B">Result B</option>
                            <option value="Result C">Result C</option>
                        </select>
                    </div>
                    <div className="mb-4">
...
export default AddInvestigationResultMandatoryConditions;
