...
const AddInvestigation = () => {
    ...
    const onSubmit = async (data) => {
        ...
        const tatValue = `${data.tatValue || "0"} ${data.tatUnit || "hours"}`;
        console.log("TAT Value:", tatValue); // Print TAT value to console
        ...
        const payload = {
            ...
            ppprice: parseFloat(data.pppPrice) || null,
            ...
            results: results.map((r) => ({
                ...
                order: r.order || 1,
                roundOff: r.roundOff || 2,
                showTrends: r.showTrends || false,
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200">
                ...
                <div className="p-6 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6">
                    ...
                    <div>
                        ...
                        <input {...register("derivedtest")} placeholder="External Test ID" className="w-full border px-3 py-2 rounded" />
