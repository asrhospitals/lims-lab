...
const UpdateReferalDoctor = () => {
  ...
  useEffect(() => {
    const fetchHospitals = async () => {
      try {
        ...
        const response = await axios.get("https://asrlab-production.up.railway.app/lims/master/get-hospital", {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const authToken = localStorage.getItem("authToken");
      await axios.put(
        `https://asrlab-production.up.railway.app/lims/master/update-refdoc/${referalDoctorToUpdate?.id}`,
        payload,
        {
          headers: { Authorization: `Bearer ${authToken}` },
        }
