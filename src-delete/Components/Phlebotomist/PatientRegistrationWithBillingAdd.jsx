...
const PatientRegistrationWithBillingAdd = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      toast.success("Patient registered With Billing successfully!");
      reset();
      navigate("/patient-registration-with-billing"); // Redirect to the patient list
    } catch (error) {
      toast.error("Failed to register patient With Billing.");
      console.error(error);
    } finally {
      ...
      <div className="fixed top-[61px] w-full z-10">
        <nav className="flex items-center text-sm font-medium justify-start px-4 py-2 bg-gray-50 border-b shadow-lg">
          <ol className="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li>
              <Link to="/patient-registration-with-billing" className="text-gray-700 hover:text-teal-600">Patients</Link>
            </li>
            <li className="text-gray-400">/</li>
            <li className="text-gray-500">Add Patient (Patient Registration With Billing) </li>
          </ol>
        </nav>
      </div>
      ...
      <div className="w-full mt-16 px-4 space-y-4 text-sm">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200">
          <div className="border-b border-gray-200 px-6 py-4 bg-gradient-to-r from-teal-600 to-teal-500">
            <h4 className="font-semibold text-white">Add Patient (Patient Registration With Billing)</h4>
          </div>
...
export default PatientRegistrationWithBillingAdd;
