      ...
      try {
        ...
        const data = [
          ...
          },
          {
            ...
            investigationShortcode: "102, 108, 112",
          },
          {
            id: 3,
            name: "Anaya Gupta",
            ...
            investigationShortcode: "101, 105",
          },
          {
            id: 4,
            name: "Reyansh Verma",
          ...
          },
          {
            ...
            investigationShortcode: "105, 113, 118",
          }
        ];
      ...
      <div className="fixed top-[61px] w-full z-10">
        <nav className="flex items-center font-medium justify-start px-4 py-2 bg-gray-50 border-b shadow-lg transition-colors">
          <ol className="inline-flex items-center space-x-1 md:space-x-3 text-sm font-medium">
            ...
            <li>
              <Link to="/patient-ppp-registration" className="text-gray-700 hover:text-teal-600 transition-colors">
                Patients
              </Link>
            </li>
            <li className="text-gray-400">/</li>
            <li aria-current="page" className="text-gray-500">
              View Patients PPP Registration
            </li>
          </ol>
        </nav>
      </div>
      ...
      <div className="w-full mt-12 px-0 sm:px-2 space-y-4 text-sm">
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 mb-4">
            <h2 className="text-lg sm:text-xl font-bold text-gray-800">Patient PPP Registration List</h2>
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            <button
              onClick={() => navigate("/patient-ppp-registration-add")}
