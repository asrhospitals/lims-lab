...
const Sidebar = ({
  ...
  const userNodalName = localStorage.getItem("nodalname") || "";
  
  
  const user = {
    name: userName,
    shortName: userRole,
    department: userModule,
    shortDept: userNodalName,
  ...
  const allMenuItems = [
    { type: "label", label: "Technician Panel" },
    { name: "Dashboard", icon: <FaHome />, link: "", roles: ["technician"] },

    {
      ...
      roles: ["technician"],
      children: [
        { name: "Pending Samples", link: "/", roles: ["technician"] },
        // { name: "Sample Under Process", link: "/", roles: ["technician"] },
        // { name: "Redo / Intervention", link: "/", roles: ["technician"] },
